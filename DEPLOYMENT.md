...
VITE_MOYASAR_PUBLISHABLE_KEY=YOUR_MOYASAR_PUBLISHABLE_KEY
VITE_ADMIN_BOOTSTRAP_PASSWORD=YOUR_ADMIN_BOOTSTRAP_PASSWORD
VITE_DEV_BOOTSTRAP_PASSWORD=YOUR_DEV_BOOTSTRAP_PASSWORD
```
